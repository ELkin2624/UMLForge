...
def generate_project(
    ...
    out_path, _checksum, warnings = model_service.generate_project(
        uml_model=uml_model,
        project_name=request.project_name,
        package_name=request.package_name,
        output_base=storage_service.base_output_dir,
        local_output_path=request.local_output_path,
    )
    ...
    background_tasks.add_task(storage_service.cleanup_path, out_path.parent)
