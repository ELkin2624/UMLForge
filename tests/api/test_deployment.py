...
from services.api.services.deployment_service import DEPLOYMENT_LOCK
...
@patch(
    "services.api.services.deployment_service.check_docker_available", return_value=True
)
@patch(
    "services.api.services.deployment_service.check_newman_available", return_value=True
)
